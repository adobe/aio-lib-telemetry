...
- [#109](https://github.com/adobe/aio-lib-telemetry/pull/109) [`473880a`](https://github.com/adobe/aio-lib-telemetry/commit/473880a09ecbcf2cc9fc1910bfa671a7f77ea4ac) Thanks [@iivvaannxx](https://github.com/iivvaannxx)! - Update the following dependencies:
  - `@opentelemetry/api` `^1.9.0` → `^1.9.1`
  - `@opentelemetry/api-logs` `^0.208.0` → `^0.218.0`
  - `@opentelemetry/auto-instrumentations-node` `^0.67.0` → `^0.76.0`
  - `@opentelemetry/exporter-logs-otlp-grpc` `^0.208.0` → `^0.218.0`
  - `@opentelemetry/exporter-logs-otlp-http` `^0.208.0` → `^0.218.0`
  - `@opentelemetry/exporter-logs-otlp-proto` `^0.208.0` → `^0.218.0`
  - `@opentelemetry/exporter-metrics-otlp-grpc` `^0.208.0` → `^0.218.0`
  - `@opentelemetry/exporter-metrics-otlp-http` `^0.208.0` → `^0.218.0`
  - `@opentelemetry/exporter-metrics-otlp-proto` `^0.208.0` → `^0.218.0`
  - `@opentelemetry/exporter-trace-otlp-grpc` `^0.208.0` → `^0.218.0`
  - `@opentelemetry/exporter-trace-otlp-http` `^0.208.0` → `^0.218.0`
  - `@opentelemetry/exporter-trace-otlp-proto` `^0.208.0` → `^0.218.0`
  - `@opentelemetry/instrumentation` `^0.208.0` → `^0.218.0`
  - `@opentelemetry/instrumentation-graphql` `^0.56.0` → `^0.66.0`
  - `@opentelemetry/instrumentation-http` `^0.208.0` → `^0.218.0`
  - `@opentelemetry/instrumentation-undici` `^0.19.0` → `^0.28.0`
  - `@opentelemetry/otlp-exporter-base` `^0.208.0` → `^0.218.0`
  - `@opentelemetry/otlp-grpc-exporter-base` `^0.208.0` → `^0.218.0`
  - `@opentelemetry/resources` `^2.0.1` → `^2.7.1`
  - `@opentelemetry/sdk-logs` `^0.208.0` → `^0.218.0`
  - `@opentelemetry/sdk-metrics` `^2.0.0` → `^2.7.1`
  ...
  - `@opentelemetry/winston-transport` `^0.19.0` → `^0.28.0`
